...
public class MainBranchControllerTest {

    private static final String basePath = "/main-branches";
    ...
    public void test_07_PatchIsAllowedForAdmin() throws Exception {
        // Arrange
        Integer id = 13;
        MainBranch item = new MainBranch();
        item.setId(id);
        item.setName("Test");
        item.setAssociationId(1);
        // Act
    ...
    public void test_13_DeleteIsForbiddenForNonAdmin() throws Exception {
        // Act
        mockMvc.perform(withHeaders(delete(basePath + "/13")))
            .andExpect(status().isForbidden());
    }
    ...
    public void test_15_DeleteMultipleIsForbiddenForNonAdmin() throws Exception {
        // Act
        mockMvc.perform(withHeaders(delete(basePath + "/multiple?ids=11,12")))
            .andExpect(status().isForbidden());
    }
