...
public class StateControllerTest {
    private static final String basePath = "/states";
    ...
    public void test_13_DeleteIsForbiddenForNonAdmin() throws Exception {
        // Act
        mockMvc.perform(withHeaders(delete(basePath + "/70")))
            .andExpect(status().isForbidden());
    }
    ...
    public void test_15_DeleteMultipleIsForbiddenForNonAdmin() throws Exception {
        // Act
        mockMvc.perform(withHeaders(delete(basePath + "/multiple?ids=68,69")))
            .andExpect(status().isForbidden());
    }
