...
public class TitleControllerTest {
    ...
    private static final String basePath = "/titles";
    ...
    public void test_07_PatchIsAllowedForAdmin() throws Exception {
        // Arrange
        Integer id = 11;
        Title item = new Title(id, "Test", "Test", 11);
        // Act
    ...
    public void test_13_DeleteIsForbiddenForNonAdmin() throws Exception {
        // Act
        mockMvc.perform(withHeaders(delete(basePath + "/11")))
            .andExpect(status().isForbidden());
    }
    ...
    public void test_15_DeleteMultipleIsForbiddenForNonAdmin() throws Exception {
        // Act
        mockMvc.perform(withHeaders(delete(basePath + "/multiple?ids=9,10")))
            .andExpect(status().isForbidden());
    }
