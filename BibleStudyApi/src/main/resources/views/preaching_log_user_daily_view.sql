CREATE VIEW dbo.preaching_log_user_daily_view AS
...
GROUP BY u.id, u.display_name, l.date, p.thumbnail_url , u.team_id, u.team_name, u.group_id, u.group_name, u.church_id,
