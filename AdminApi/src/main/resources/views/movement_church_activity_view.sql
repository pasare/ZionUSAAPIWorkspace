create view dbo.movement_church_activity_view WITH SCHEMABINDING as
select newid()               as id,
       a.id                  as activity_id,
...
group by a.id, a.name, m.id, m.name, m.start_date, m.end_date, al.church_id, al.church_name
go
