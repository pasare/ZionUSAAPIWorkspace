...
@Entity
@Table(
    name = "movements_goals_results",
    uniqueConstraints = {@UniqueConstraint(columnNames = {"movementId", "movementGoalTypeId", "referenceId"})}
)
public class MovementGoalResult implements BaseDomain<Integer> {
    @Id
    @Column(name = "id")
    ...
    public boolean equals(Object o) {
        ...
        MovementGoalResult that = (MovementGoalResult) o;
    ...
    @Immutable
    @Table(name = "movements_goals_results_association_view")
    ...
    @EqualsAndHashCode(onlyExplicitlyIncluded = true)
    @Immutable
    @Table(name = "movements_goals_results_church_view")
    ...
    @EqualsAndHashCode(onlyExplicitlyIncluded = true)
    @Immutable
    @Table(name = "movements_goals_results_overseer_view")
